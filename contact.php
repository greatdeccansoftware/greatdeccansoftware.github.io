...
<head>
    ...
    <title>Thank you for Contacting us | GreatDeccanSoftware</title>
...
<body class="no_js">
    ...
    <div id="header">
        ...
        <div class="inner">
            ...
            <!-- START LOGO -->
            <div id="logo">
                <a href="index.html" title="GreatDeccanSoftware">GreatDeccanSoftware</a>
            </div>
            <!-- END LOGO -->
    ...
    <div id="content">
        ...
        <div class="inner">                 
			...
			{
					 $strTo="sanjay@GreatDeccanSoftware.com";
